...
exports.et = (originalText) => {
  ...
  exports.eot = (data) => {
    return {
      encData: exports.et(JSON.stringify(data)), // Encrypt JSON stringified data
    };
  };
  ...
  exports.dot = (data) => {
    try {
      const decData = exports.dt(data.encData); // Decrypt the encData field
